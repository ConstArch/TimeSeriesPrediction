...
\begin{document}
	...
	\begin{frame}{Цель и задачи работы}
		\small
		\textbf{Цель:} построение СК-оптимального предиктора $Y_{t+h}$ по $Y_t,\dots,Y_{t-p+1}, X_t,\dots,X_{t-q+1}$, где $X_t$ и $Y_t$ --- временные ряды DGS1 и DGS3 соответственно.
	...
	\begin{frame}{СК-оптимальный предиктор}
